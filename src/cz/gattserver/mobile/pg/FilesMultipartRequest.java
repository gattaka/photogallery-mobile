...
/**
 * Úprava původního MultipartRequest, který neumožňoval pod jedním "name" poslat
 * více souborů, protože měl vazbu 1:1. Pokud se posílá více souborů a je
 * potřeba více souborů poslat pod jedním arg-name, musí MultipartRequest mít
 * vazbu 1:N
 * 
 * @author Hynek
 *
